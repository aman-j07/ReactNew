    ...
    return (
      <div id={style.first}>
        <div id={style.divLogo}>
          ...
          <div id={style.divPlus}><p id={style.paraExplore}>Explore</p><p id={style.paraPlus}>Plus</p><img alt="plusLogo" src="https://static-assets-web.flixcart.com/fk-p-linchpin-web/fk-cp-zion/img/plus_aef861.png"></img></div>
        </div>
